      ...
      <div className="px-4 pt-4 pb-3 border-b border-border">
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 bg-black rounded-sm flex items-center justify-center shrink-0">
            <svg width="12" height="12" viewBox="0 0 16 16" fill="white"><rect x="2" y="2" width="5" height="5"/><rect x="9" y="2" width="5" height="5"/><rect x="2" y="9" width="5" height="5"/><rect x="9" y="9" width="5" height="5"/></svg>
          </div>
          <div>
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-2.5 px-4 py-2.5 text-2xs font-semibold tracking-widest transition-colors ${
                active
                  ? 'bg-black text-white'
                  : 'text-ink-3 hover:text-ink hover:bg-surface-dim'
              }`}
            >
